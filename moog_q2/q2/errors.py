...
def error_one(Star_in, grid, dteff, dvt, dlogg, nlte, SolvePars=None,  Ref=object):
    if SolvePars == None:
        SolvePars = q2.specpars.SolvePars
        SolvePars.grid = grid
    ...
    hx1  = (s.iron_stats['afe1'] +nlte) - s.iron_stats['afe2']
    ...
    hx2  = (s.iron_stats['afe1'] +nlte) - s.iron_stats['afe2']
